...
$getEmailQuery = mysqli_query($con, "SELECT name FROM student");
...
if(isset($_POST['submit'])){
   ...
   $query = mysqli_prepare($con, "SELECT * FROM student WHERE email = ? AND password = ?");
								...
								<div class="m-sm-4">
									...
									<form action="" method="POST">
										...
										<div class="mb-3">
											...
											<small>
                                                Login as <a href="../admin/login.php">Admin</a>?
                                            </small>
										</div>
