        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3"><strong>Your Pending Dues</strong></h1>
                            ...
                            <div class="card flex-fill">
                                <table class="table table-hover my-0">
                                    ...
                                    <tbody>
                                        <?php
                                        $i = 0;
                                        $sql = "SELECT * FROM fee WHERE status = '0' && student_id = '".$student['student_id']."' ORDER BY due_date";
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><a href="#"><span class="badge bg-danger">Pending</span></a></td>
                                                </tr>
                                        <?php
                                            }
                                        }
