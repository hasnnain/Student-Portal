						...
						<div class="col-md-4 col-xl-3">
							<div class="card mb-3">
								...
								<div class="card-body text-center">
									<img src="studentImages/<?php echo $student['photo']; ?>" alt="Your Image" class="img-fluid rounded-circle mb-2" width="128" height="128" />
								...
								<div class="card-body h-100">
									...
									<div class="d-flex align-items-start">
										<div class="flex-grow-1">
											<h4><strong>ID:</strong> <?php echo $student['student_id']; ?></h4><br />
									...
									<div class="d-flex align-items-start">
										<div class="flex-grow-1">
											<h4><strong>Email:</strong> <?php echo $student['email']; ?></h4><br />
