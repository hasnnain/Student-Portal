...
if (isset($_POST['submit'])) {
    ...
    $check = "SELECT total_marks,obtained_marks FROM mids WHERE id='$updid'";
    ...
    if ($res) {
        $success = '<div class="alert alert-success alert-dismissible fade show mt-2">
                        ...
                        Md Marks Updated Successfully.
                    </div>';
    } else {
        $error = '<div class="alert alert-danger alert-dismissible fade show">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    Error updating mid marks: ' . mysqli_error($db) . '
                </div>';
    }
}
?>
                        ...
                        <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
                            <div class="d-table-cell align-middle">
                                <div class="text-center mt-4">
                                    <h1 class="h2">Update Mid Marks</h1>
                                    <p>
                                        <?php
                                        if (isset($error)) {
                                            echo $error;
