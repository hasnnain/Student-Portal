...
if (isset($_POST['submit'])) {
    ...
    $check = "SELECT name FROM courses WHERE id='$updid'";
                                        ...
                                        <div class="m-sm-4">
                                            <form method="POST" enctype="multipart/form-data">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control form-control-lg" type="text" name="name" placeholder="Enter Course Name" />
                                                ...
                                                <div class="text-center mt-3">
                                                    <button type="submit" name="submit" class="btn btn-lg btn-primary">Update Course</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
