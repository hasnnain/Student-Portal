...
if (isset($_POST['submit'])) {
    if ($_POST['quiz'] == '') {
        $error = '<div class="alert alert-danger alert-dismissible fade show">
                    ...
                    <strong>Enter Quiz Name!</strong>
                  </div>';
    } else {
        $sql = "INSERT INTO quiz(student_id,quiz,total_marks,obtained_marks,date) VALUE('".$_POST['student_id']."','".$_POST['quiz']."','".$_POST['total_marks']."','".$_POST['obtained_marks']."','".$_POST['date']."')";
        ...
        if ($conn->query($sql)==TRUE) {
            ...
            $error = '<div class="alert alert-danger alert-dismissible fade show">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <strong>Error in adding quiz marks.</strong>
                      </div>';
        }
    }
}
                                        ...
                                        <div class="m-sm-4">
                                            <form method="POST" enctype="multipart/form-data">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control form-control-lg" type="text" name="quiz" placeholder="Enter Quiz Name" />
