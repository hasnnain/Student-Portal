        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3"><strong>Paid Dues</strong></h1>
                            ...
                            <div class="card flex-fill">
                                <table class="table table-hover my-0">
                                    ...
                                    <tbody>
                                        <?php
                                        $i = 0;
                                        $sql = "SELECT * FROM fee WHERE status = '1' ORDER BY student_id";
                                        $query = mysqli_query($db, $sql);
                                        $totalFee = 0; // Variable to store the total fee

                                        if (!mysqli_num_rows($query) > 0) {
                                            echo '<td colspan="5"><center>No Paid Dues</center></td>';
                                        } else {
                                        ...
                                        ?>
                                        <tr>
                                            <td>Total Paid Fee by Students = </td>
                                            <td></td>
